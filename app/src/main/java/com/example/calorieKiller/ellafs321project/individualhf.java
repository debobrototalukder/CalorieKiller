...
public class individualhf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.individual_hf);
        ...
        forgotPassDialog1.setContentView(R.layout.helpin);
    ...
    public void nxtButtonClicked(View view) {
        ...
        Intent intent = new Intent(this, individualhs.class);
